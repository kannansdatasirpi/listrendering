<!--when we build web application the common scenario display the list of item (ex.list of name) repeat the html for each item in the list .
...
export default {
  ...
  data(){
    return {
      names: ['Tom', 'harry', 'peter'],
      fullNames: [
        {first:'tom',last:'wayne'},
